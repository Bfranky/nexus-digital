  ...
  return (
    <div>
      <div style={{marginBottom:22}}>
        ...
        <p style={{color:"var(--text-muted)",fontSize:"0.85rem",marginTop:4}}>Performance overview</p>
      </div>
        ...
        <>
          <div className="grid-stats" style={{marginBottom:24}}>
            {[
              ...
              {label:"Pipeline",        value:formatMoney(pending),accent:"#fbbf24"},
            ].map(s=>(
              <div key={s.label} className="stat-card">
                <div style={{fontFamily:"var(--font-display)",fontWeight:700,fontSize:"1.3rem",color:s.accent}}>{s.value}</div>
          ...
          <div className="grid-2">
            ...
            <div className="glass" style={{borderRadius:16,padding:20}}>
              <h2 style={{fontFamily:"var(--font-display)",fontWeight:700,fontSize:"0.95rem",color:"#fff",marginBottom:16}}>Pipeline Breakdown</h2>
            ...
            {/* Category */}
            <div className="glass" style={{borderRadius:16,padding:20}}>
              <h2 style={{fontFamily:"var(--font-display)",fontWeight:700,fontSize:"0.95rem",color:"#fff",marginBottom:16}}>By Category</h2>
              {categories.length===0
